                ...
                <div class="menu">
                    ...
                    <div class="navigation-side">
                        <ul>
                            ...
                            <li><a href="{{ url('/category') }}" class="btn my-1 category-btn"
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-sm-12 col-md-8">
                        <form action="{{ url('subcategory/' . $subcategory->id) }}" method="POST" id="form-task"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="subcategory"
                                        class="form-control @error('subcategory') is-invalid @enderror" id="plat-name"
                                        value="{{ old('subcategory', $subcategory->subcategory) }}" />
                                    @error('subcategory')
                            ...
                            <div class="modal-footer border-0">
                                ...
                                <button type="submit" name="add-multiple-post" class="btn btn-primary  task-action-btn"
                                    id="task-save-btn">Update SubCategory</button>
                            </div>
                        </form>
                    </div>
                </div>
