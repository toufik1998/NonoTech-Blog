            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-sm-12 col-md-8">
                        <form action="{{ url('tag/'.$tag->id) }}"  method="POST" id="form-task" enctype="multipart/form-data">
                            @csrf
                            @method("PATCH")
                                ...
                                <div class="modal-body">
                                        ...
                                        {{-- <div class="mb-3">
                                            ...
                                            <input type="text" value="{{$tag->name}}" name="tag" class="form-control" id="plat-name"/>
                                        </div> --}}

                                        <div class="mb-3">
                                            <label class="form-label text-white" for="plat-name">Category title</label>
                                            <input type="text" name="tag" class="form-control @error('tag') is-invalid @enderror" id="plat-name" value="{{ old('tag', $tag->name) }}"/>
                                            @error('tag')
