...
@section('title', 'Dashboard || Create Tag page')
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-sm-12 col-md-8">
                        <form action="{{ url('tag') }}" method="POST" id="form-task" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="tag"
                                        class="form-control @error('tag') is-invalid @enderror" id="plat-name"
                                        value="{{ old('tag') }}" />
                                    @error('tag')
                            ...
                            <div class="modal-footer border-0">
                                ...
                                <button type="submit" name="add-multiple-post" class="btn btn-primary task-action-btn"
                                    id="task-save-btn">Add Tag</button>
                            </div>
                        </form>
                    </div>
                </div>
