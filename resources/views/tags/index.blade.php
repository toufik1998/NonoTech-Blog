                    ...
                    <div class="col-sm-12 col-md-7 col-lg-5">
                        <form action="{{ url('tag') }}" method="GET" class="d-flex">
                            <input class="form-control me-2" name="searchQuery" type="search"
                                placeholder="Search for tag" aria-label="Search">
                                        ...
                                        @foreach ($tags as $item)
                                            <tr style="color: #fff; border-bottom: black;">
                                                ...
                                                <td>
                                                    ...
                                                    <form method="post" action="{{ url('/tag' . '/' . $item->id) }}"
                                        ...
                                        <ul class="pagination">
                                            ...
                                            @else
                                                <li class="page-item"><a class="page-link"
                                                        href="{{ $tags->previousPageUrl() }}" rel="prev">&laquo;</a>
                                                </li>
                                            @endif
                                            ...
                                            @if ($tags->hasMorePages())
                                                <li class="page-item"><a class="page-link"
                                                        href="{{ $tags->nextPageUrl() }}" rel="next">&raquo;</a></li>
                                            @else
