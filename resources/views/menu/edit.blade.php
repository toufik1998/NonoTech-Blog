                ...
                <div class="menu">
                    ...
                    <div class="navigation-side">
                        <ul>
                            ...
                            <li><a href={{ route('category.index') }} class="btn my-1 category-btn"
                            ...
                            <li><a href="{{ url('/tag') }}" class="btn tag-btn mt-1"
            ...
            <div class="d-flex align-items-center mb-3">
                <div>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" style="color: #ff8906">NanoTech || Edit Post </li>
                    </ol>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-sm-12 col-md-8">
                        <form action="{{ url('adminboard/' . $post->id) }}" method="POST" id="form-task"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="title"
                                        class="form-control @error('title') is-invalid @enderror" id="plat-name"
                                ...
                                <livewire:dynamic-subcategories :selected-category="$post->category_id ?? null" :selected-subcategory="$post->subcategory_id ?? null" />

                                <div class="form-group mb-3">
                                    <label for="tags" class="text-white d-block mb-3 form-label">Tags:</label>
                                    @foreach ($tags as $item)
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input cursor-pointer" type="checkbox" name="tags[]"
                                ...
                                <div class="mb-0">
                                    ...
                                    <input type="file" name="image_path"
                                        class="form-control @error('image_path') is-invalid @enderror" id="plat-image" />
                                    @error('image_path')
                                        <div class="invalid-feedback text-danger">{{ $message }}</div>
                                    @enderror
                                    @if ($post->image_path)
                                        <div class="mt-2">
                                            <img src="../../images/{{ $post->image_path }}" alt="Post Image"
                                                style="width: 75px; height: 75px" class="rounded-circle bg-white">
                                        </div>
                                    @endif
                                </div>
                            ...
                            <div class="modal-footer border-0">
                                ...
                                <button type="submit" name="add-multiple-post" class="btn btn-primary  task-action-btn"
                                    id="task-save-btn">Update Post</button>
                            </div>
                        </form>
                    </div>
                </div>
