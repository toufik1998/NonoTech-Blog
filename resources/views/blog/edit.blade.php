                ...
                <div class="menu">
                    ...
                    <div class="navigation-side">
                        ...
                        <a href="#" class="icon-post3 text-center">
                            <i class="fa-solid fa-house fa-2x text-warning mb-3"></i>
                        </a>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-sm-12 col-md-8">
                        <form action="/blog/{{ $post->id }}" method="POST" id="form-task"
                            ...
                            <div class="modal-footer border-0">
                                ...
                                <button type="submit" class="btn btn-primary task-action-btn" id="task-save-btn">Update
                                    Post</button>
                            </div>
                        </form>
                    </div>
