    ...
    <div id="app" class="app app-header-fixed app-sidebar-fixed">
                ...
                <div class="menu">
                    ...
                    <div class="navigation-side">
                        ...
                        <ul>
                            ...
                            <li><a href={{ route('category.index') }} class="btn category-btn  my-1"
                                    style="width: 100%; border-bottom-right-radius: 0;">Categories</a></li>
                            <li><a href="#" class="btn post-btn"
                                    style="width: 100%; border-bottom-right-radius: 0;">Articles</a></li>
                            <li><a href="{{ url('/tag') }}" class="btn post-btn mt-1 tag-btn"
                                    style="width: 100%; border-bottom-right-radius: 0;">Tags</a></li>
                            <li><a href={{ route('subcategory.index') }} class="btn subcategory-btn  my-1"
                                    style="width: 100%; border-bottom-right-radius: 0;">SubCategories</a></li>
        ...
        <div id="content" class="app-content">
            <div class="d-flex align-items-center mb-3">
                ...
                <div class="ms-auto">
                    <a href={{ url('/adminboard/create') }} id="addButton"
                    ...
                    <a href={{ url('/category/create') }} id="addButton"
                        class="btn btn-rounded text-white px-4 rounded-pill mb-2" style="background-color: #ff8906"><i
                            class="fa fa-plus fa-lg me-2 ms-n2 text-white"></i> Add Category</a>
                    <a href={{ url('/tag/create') }} id="addButton"
                        class="btn btn-rounded text-white px-4 rounded-pill mb-2" style="background-color: #ff8906"><i
                            class="fa fa-plus fa-lg me-2 ms-n2 text-white"></i> Add Tag</a>
                    <a href={{ url('/subcategory/create') }} id="addButton"
                        class="btn btn-rounded text-white px-4 rounded-pill mb-2" style="background-color: #ff8906"><i
                            class="fa fa-plus fa-lg me-2 ms-n2 text-white"></i> Add Subcategory</a>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-7 col-lg-5">
                        <form action="{{ url('adminboard') }}" method="GET" class="d-flex">
                            <input class="form-control me-2" name="searchQuery" type="search"
                                placeholder="Search for post" aria-label="Search">
                        ...
                        <div class="shadow-4 rounded-5 overflow-hidden">
                            <div class="table-responsive">
                                <table class="table align-middle mb-0"
                                    style="background-color: #2F3843; border-radius: 1rem;">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($posts as $item)
                                            <tr style="color: #fff; border-bottom: black;">
                                                ...
                                                <td>
                                                    <span
                                                        class="badge badge-success rounded-pill ms-4">{{ $item->category->category }}</span>
                                                </td>
                                                <td>
                                                    <p class="fw-normal mb-1 ms-2">{{ $item->user->name }}</p>
                                                </td>
                                                <td>
                                                    <a href="/adminboard/{{ $item->id }}"
                                                        class="btn bg-success text-white btn-sm btn-rounded mt-2">
                                                        <i class="fa-regular fa-eye text-white"></i>
                                                    </a>

                                                    <a href="{{ url('adminboard/' . $item->id . '/edit') }}"
                                                        class="btn bg-success text-white btn-sm btn-rounded mt-2">
                                                    ...
                                                    <form method="post"
                                                        ...
                                                        <button type="submit" name="delete"
                                                            ...
                                                            class="btn bg-danger text-white btn-sm btn-rounded mt-2 ">
                                        ...
                                        <ul class="pagination">
                                            ...
                                            @else
                                                <li class="page-item"><a class="page-link"
                                                        href="{{ $posts->previousPageUrl() }}" rel="prev">&laquo;</a>
                                                </li>
                                            @endif
                                            ...
                                            @if ($posts->hasMorePages())
                                                <li class="page-item"><a class="page-link"
                                                        href="{{ $posts->nextPageUrl() }}" rel="next">&raquo;</a>
                                                </li>
                                            @else
